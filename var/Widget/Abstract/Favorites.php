...
class Widget_Abstract_Favorites extends Widget_Abstract{
    ...
    public function filter(array $value){
        ...
        if($value['type']=='post'){
            $value['content'] = $this->widget('Widget_Contents_Query@cid_'.$value['srcId'],'cid='.$value['srcId']);
        }
        if($value['type']=='tag'){
            $value['node'] = $this->widget('Widget_Metas_Query@mid_'.$value['srcId'],'mid='.$value['srcId']);
        }
        return $value;
    }
    /**
