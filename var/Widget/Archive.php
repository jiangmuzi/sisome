...
class Widget_Archive extends Widget_Abstract_Contents
{
    ...
    // modified_by_jiangmuzi 2015.09.22
    /**
     * @param string $archiveMid the $_archiveMid to set
     */
    public function setArchiveMid($archiveMid)
    {
        $this->_archiveMid = $archiveMid;
    }
    // end modified
    /**
    ...
    // modified_by_jiangmuzi 2015.09.22
    /**
     * @return the $_archiveMid
     */
    public function getArchiveMid()
    {
        return $this->_archiveMid;
    }
    // end modified
    /**
    ...
    private function tagHandle(Typecho_Db_Query $select, &$hasPushed)
    {
        ...
        // modified_by_jiangmuzi 2015.09.23
        // 判断是否收藏
        if('tag' == $this->type && $this->user->hasLogin()){
            $this->parameter->isFavorite = $this->widget('Forum_Favorites')->isFavorite('tag',$tag['slug']);
        }
        // end modified
        /** 插件接口 */
