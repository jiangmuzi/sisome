...
<div id="main">
    ...
    <?php $this->widget('Forum_List_Post@indexRecent', 'limit=30')->to($archives);?>
	...
	<?php while($archives->next()): ?>
        <article class="cell post">
			...
			<ul class="post-meta">
				...
				<li><span><?php echo Forum_Common::formatTime($archives->created,'Y-m-d H:i:s'); ?></span></li>
            ...
            <?php if ($categories->have()): ?>
                <?php while($categories->next()): ?>
                    <div class="cell nodes">
                      ...
                      <?php Typecho_Widget::widget('Forum_List_Tags@Tags_'.$categories->mid, 'sort=count&ignoreZeroCount=0&desc=count&limit=20&parent='.$categories->mid)->to($tags); ?>
