...
<div class="box cell" id="<?php $this->respondId(); ?>">
	...
	<form method="post" action="<?php $this->commentUrl() ?>" id="comment-form" role="form">
        ...
        <p class="m20 aligncenter">
                        已注册用户请 <a class="btn" href="<?php $this->options->someUrl('login');?>?r=<?php echo $this->request->getRequestUrl();?>"><?php _e('登录');?></a> 或者 <a class="btn" href="<?php $this->options->someUrl('register');?>"><?php _e('现在注册');?></a></p>
        <?php endif; ?>
	</form>
